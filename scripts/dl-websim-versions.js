...
// but GitHub Copilot is probably more helpful.
// What I've done is actually prompt ChatGPT twice, copy both results into the objects using multi-cursor editing,
// so I can pick one/edit it manually, and delete the other.
// One could also just edit commit messages later, possibly in one big `rebase -i`.
